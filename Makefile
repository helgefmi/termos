...
FS_SRC=src/fs/vfs.o src/fs/initrd.o src/fs/vfs_cache.o src/fs/devfs/devfs.o src/fs/rootfs.o
...
CFLAGS=-nostdlib -nostdinc -fno-builtin -fno-stack-protector -I src/include -m32 $(C_COMMON_FLAGS)
